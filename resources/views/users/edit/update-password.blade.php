    ...
    <x-card class="space-y-4">
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                {{ __('На этой странице вы можете изменить свой текущий пароль. Пожалуйста, введите свой старый пароль, а затем новый пароль, который вы хотите установить. Убедитесь, что новый пароль соответствует требованиям безопасности, чтобы защитить ваш аккаунт. После успешного изменения пароля вы сможете использовать новый пароль для входа в систему.') }}
            </p>
        </header>
